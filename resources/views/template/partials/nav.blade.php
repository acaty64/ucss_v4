...
@if(Session::get('ctype')=='Responsable')
    ...
    <li class='dropdown'>
    <a href='#' class='dropdown-toggle' role='button' id='dropdownMenu2' data-toggle='dropdown' aria-haspopup='true' aria-expanded='false'>Disponibilidad<span class='caret'></span>
    </a>
    <ul class='dropdown-menu' aria-labelledby='dropdownMenu2'>
    ...
    <li><a href="{{ route('responsable.grupocurso.index')}}">Prioridad Docentes</a></li>
@endif
@if(Session::get('ctype')=='Administrador')
    <li><a href="{{ route('home')}}">Inicio</a></li>
    <li><a href="{{ route('administrador.user.index')}}">Usuarios</a></li>
    <li class='dropdown'>
    <a href='#' class='dropdown-toggle' role='button' id='dropdownMenu2' data-toggle='dropdown' aria-haspopup='true' aria-expanded='false'>Grupos de Cursos<span class='caret'></span>
    </a>
    <ul class='dropdown-menu' aria-labelledby='dropdownMenu2'>
    ...
    <li class='dropdown'>
    <a href='#' class='dropdown-toggle' role='button' id='dropdownMenu3' data-toggle='dropdown' aria-haspopup='true' aria-expanded='false'>Verificaciones<span class='caret'></span>
    </a>
    ...
    <li class='dropdown'>
    <a href='#' class='dropdown-toggle' role='button' id='dropdownMenu4' data-toggle='dropdown' aria-haspopup='true' aria-expanded='false'>Acciones<span class='caret'></span>
    </a>
...
@else
<li class="dropdown">
<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">{{ Auth::user()->name_login }} <span class="caret"></span>
</a>
